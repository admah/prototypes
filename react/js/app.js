...
render: function() {
  return (
    <div id="emails" className="emailBox">
      <table>
        <thead>
            <tr>
        ...
        <tbody>
          	<EmailList data={this.props.data} />
        </tbody>
      </table>
    </div>
  );
...
var EmailList = React.createClass({
  render: function() {
    var emailNodes = this.props.data.map(function (email) {
      return (
        <Email sent={email.sent} subject={email.subject}>
        </Email>
      );
    });
    return (
...
var Email = React.createClass({
  render: function() {
    return (
    	<tr className="email single">
		  <td className="actions">
            <button className="edit">Edit</button>
            <button className="delete" onClick={this.emailDelete}>Delete</button>
          </td>
          <td className="sent">{this.props.sent}</td>
          <td className="subject">{this.props.subject}</td>
        </tr>
    );
  },
